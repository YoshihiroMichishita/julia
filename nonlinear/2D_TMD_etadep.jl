...
function main(arg::Array{String,1})
    ...
    CSV.write("./etadep_YXX.csv", save_data2)

    ENV["GKSwstype"]="nul"
    Plots.scalefontsizes(1.4)
    p1 = plot(mu0, -Drude_XXX_mu, label="eBC",xlabel="η",ylabel="σ",title="η-dependence", width=4.0, marker=:circle, markersize = 4.8)
